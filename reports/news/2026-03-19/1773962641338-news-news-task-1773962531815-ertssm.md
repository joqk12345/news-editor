...
- agent: news/news
- requestId: 1773962531815-ertssm
- 生成时间(UTC): 2026-03-19T23:24:01.337Z
...
graph TD
  subgraph "Concept Map"
    A["一辈子的事 / Lifelong Passion"] --> B["淡定 / Calmness"]
    C["定投 / Dollar-Cost Averaging"] --> D["时间积累 / Time Accumulation"]
    D --> E["被动持有 / Passive Holding"]
    F["没有热爱做的事情 / Lack of Passion"] --> G["性格不淡定 / Not Calm Personality"]
    G --> H["南柯一梦 / Empty Dream"]
  end
```
...
flowchart LR
  subgraph "Causal Chain"
    P["找到一生热爱的事业 / Finding Lifelong Passion"] --> C["淡定心态 / Calmness"]
    C --> NP["无恐慌 / No Panic"]
    DCA["定投 / Dollar-Cost Averaging"] --> TA["时间积累 / Time Accumulation"]
    TA --> PH["被动持有 / Passive Holding"]
    LP["缺乏热爱 / Lack of Passion"] --> NC["不淡定 / Not Calm"]
    NC --> ED["南柯一梦 / Empty Dream"]
  end
```
