...
- agent: news/news
- requestId: 1774221448730-vrzxjs
- 生成时间(UTC): 2026-03-22T23:19:22.617Z
...
graph TD
  subgraph "Concept Map"
    C1["世界模型 / World Model"]
    C2["现实扭曲引力场 / Reality distortion field"]
    C3["划帆船式放权管理 / Sailing-style delegated management"]
    C4["斜杠青年 / Slash youth"]
    C1 --> C2
    C2 --> C3
    C3 --> C4
...
flowchart LR
  subgraph "Causal Chain"
    T["人物特质分析 / Analysis of Personal Traits"]
    R["本文阐述了杨立昆在AI科研愿景、科学家正直、管理哲学及个人爱好方面的核心特质。"]
    A["杨立昆与谢赛宁在科研愿景上高度一致，认为LLM非人类级智能路径，主张世界模型是根本。"]
    T --> R
    R --> A
  end
```
