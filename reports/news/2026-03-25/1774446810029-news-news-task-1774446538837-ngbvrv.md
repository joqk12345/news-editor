...
- agent: news/news
- requestId: 1774446538837-ngbvrv
- 生成时间(UTC): 2026-03-25T13:53:30.025Z
...
graph TD
  subgraph "Concept Map"
    C1["CoWoS / Chip-on-Wafer-on-Substrate"]
    C2["HBM / High Bandwidth Memory"]
    C3["SerDes / Mixed Signal/Physical Connection"]
    C1 --> C2
    C2 --> C3
  end
```
