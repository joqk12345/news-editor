...
- agent: news/news
- requestId: 1774276073893-mejvqe
- 生成时间(UTC): 2026-03-23T14:28:32.041Z
...
graph TD
  subgraph "Concept Map"
    C1["自住价值 / Owner-occupancy Value"]
    C2["抵押加杠杆 / Refinance and Leverage"]
    C3["生产力工具的仓库 / Warehouse of Productive Tools"]
    C1 --> C2
    C2 --> C3
  end
```
...
flowchart LR
  subgraph "Causal Chain"
    T["房产投资策略 / Real Estate Investment Strategy"]
    R["Indigo通过将自住房产抵押套现获取低息贷款，再投资高收益市场以实现财富增值，而非直接炒房。"]
    A["选择自建或购买少量优质公寓作为自住房产。"]
    T --> R
    R --> A
  end
```
