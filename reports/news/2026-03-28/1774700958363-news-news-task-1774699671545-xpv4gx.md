...
- agent: news/news
- requestId: 1774699671545-xpv4gx
- 生成时间(UTC): 2026-03-28T12:29:18.359Z

### Runtime Trace
- 链接总结: https://www.noemamag.com/ai-is-evolving-and-changing-our-understanding-of-intelligence/ | model=openrouter/free
- 链接总结: https://www.noemamag.com/ai-is-evolving-and-changing-our-understanding-of-intelligence/ | schema_fallback=yes
- 链接总结: https://www.noemamag.com/ai-is-evolving-and-changing-our-understanding-of-intelligence/ | attempted_models=openrouter/free
...
graph TD
  subgraph "Concept Map"
    C1["DNA / DNA"]
    C2["形态素 / morphogens"]
    C3["人工智能（ALife） / artificial life (ALife)"]
    C4["功能共生 / functional symbiosis"]
    C5["最小的人工智能 / minimal artificial life"]
    C6["神经计算 / Neural Computing"]
    C1 --> C2
    C2 --> C3
    C3 --> C4
    C4 --> C5
...
flowchart LR
  subgraph "Causal Chain"
    N1["GOFAI的失败 / GOFAI's failure"]
    N2["计算神经科学和连接主义学派的兴起 / The rise of computational neuroscience and connectionism"]
    N3["20世纪计算范式 / 20th-century computing paradigm"]
    N4["机器学习的不友好环境 / Unfriendly environment for machine learning"]
    N5["真空管的不可靠性 / Unreliability of vacuum tubes"]
    N6["二进制系统的采用 / Adoption of binary system"]
    N7["二进制逻辑的自然性 / Naturalness of binary logic"]
    N8["布尔逻辑的基础 / Foundation for Boolean logic"]
    N9["真空管的最小化设计 / Minimization of vacuum tubes"]
    N10["中央处理器的构建 / Construction of CPU"]
    N11["预测大脑假说 / predictive brain hypothesis"]
    N12["有意行为和智能 / intentional behavior and intelligence"]
    N1 --> N2
    N3 --> N4
    N5 --> N6
    N7 --> N8
