...
- agent: news/news
- requestId: 1773966203304-ex3r6w
- 生成时间(UTC): 2026-03-20T00:25:20.489Z
...
graph TD
  subgraph "Concept Map"
    SB["强baseline / Strong Baseline"] --> RB["科研突破 / Research Breakthrough"]
    SI["强infra / Strong Infrastructure"] --> RB
    SE["强工程 / Strong Engineering"] --> RB
    CB["codebase / Codebase"] --> RB
    WB["弱baseline / Weak Baseline"] --> GS["假梯度信号 / False Gradient Signal"]
    WB --> SP["灌水论文 / Salami Slicing Paper"]
    SE --> SC["脚手架 / Scaffold"]
    SI --> SC
    CB --> SC
    SC --> RB
...
flowchart LR
  subgraph "Causal Chain"
    WB["弱baseline / Weak Baseline"] --> GS["假梯度信号 / False Gradient Signal"]
    WB --> SP["灌水论文 / Salami Slicing Paper"]
    SE["强工程 / Strong Engineering"] --> SC["脚手架 / Scaffold"]
    SI["强infra / Strong Infrastructure"] --> SC
    CB["codebase / Codebase"] --> SC
    SC --> RB["科研突破 / Research Breakthrough"]
    SB["强baseline / Strong Baseline"] --> RB
  end
```
