...
- agent: news/news
- requestId: 1774021413082-o5d5qs
- 生成时间(UTC): 2026-03-20T15:44:49.497Z
...
graph TD
  subgraph "Concept Map"
    A["李飞飞 / Fei-Fei Li"] --> B["定义问题 / Problem Definition"]
    B --> C["图像分类 / Image Classification"]
    C --> D["ImageNet / ImageNet"]
    D --> E["深度学习 / Deep Learning"]
    B --> F["科研哲学 / Research Philosophy"]
    F --> G["避免有限游戏 / Avoid Finite Game"]
    B --> H["真实世界 / Real World"]
    H --> I["隐形世界 / Invisible World"]
    I --> J["问题定义者 / Problem Definers"]
  end
```
### Mermaid 图 2（逻辑/因果图）
```mermaid
flowchart LR
  subgraph "Causal Chain"
    X["定义问题能力 / Problem Definition Ability"] --> Y["设定研究议程 / Set Research Agenda"]
    Y --> Z["提供试验场 / Provide Playground"]
    Z --> W["促进深度学习爆发 / Enable Deep Learning Explosion"]
    X --> V["避免有限游戏 / Avoid Finite Game"]
    X --> U["发现隐形世界 / Discover Invisible World"]
    U --> T["满足真实需求 / Meet Real Needs"]
  end
```
