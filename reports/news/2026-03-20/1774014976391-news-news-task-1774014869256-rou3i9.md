...
- agent: news/news
- requestId: 1774014869256-rou3i9
- 生成时间(UTC): 2026-03-20T13:56:16.388Z
...
graph TD
  subgraph "Concept Map"
    VI["视觉智能 / Visual Intelligence"]
    PS["处理物理信号 / Processing Physical Signals"]
    HR["构建层次化表征 / Building Hierarchical Representation"]
    LPP["实现大规模并行化处理 / Large-scale Parallel Processing"]
    AC["实现抽象认知 / Abstract Cognition"]
    FS["特征共享 / Feature Sharing"]
...
flowchart LR
  subgraph "Causal Chain"
    RPW["真实物理世界 / Real Physical World"]
    PS["处理物理信号 / Processing Physical Signals"]
    HR["构建层次化表征 / Building Hierarchical Representation"]
    AC["抽象认知 / Abstract Cognition"]
    LPP["大规模并行化处理 / Large-scale Parallel Processing"]
    FS["特征共享 / Feature Sharing"]
