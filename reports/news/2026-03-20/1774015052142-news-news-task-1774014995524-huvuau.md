...
- agent: news/news
- requestId: 1774014995524-huvuau
- 生成时间(UTC): 2026-03-20T13:57:32.139Z
...
graph TD
  subgraph "Concept Map"
    A["世界模型 / World Model"] --> B["认知架构 / Cognitive Architecture"]
    B --> C["预测性大脑 / Predictive Brain"]
    C --> D["类人智能 / Human-like Intelligence"]
    E["表征学习 / Representation Learning"] --> A
    F["大语言模型 / Large Language Model"] -.->|对比| A
    G["通用机器人 / General-purpose Robotics"] --> D
    H["理解本质 / Understanding Essence"] --> I["智能总量 / Total Intelligence"]
    I --> J["家人感 / Sense of Family"]
  end
```
...
flowchart LR
  subgraph "Causal Chain"
    X["构建世界模型 / Build World Model"] --> Y["解决推理瓶颈 / Solve Reasoning Bottleneck"]
    Y --> Z["提升物理智能 / Enhance Physical Intelligence"]
    Z --> W["实现类人智能 / Achieve Human-like Intelligence"]
    W --> V["服务真实需求 / Serve Real Needs"]
    U["理解本质 / Understand Essence"] --> T["启发他人 / Inspire Others"]
    T --> S["提升智能总量 / Increase Total Intelligence"]
  end
```
