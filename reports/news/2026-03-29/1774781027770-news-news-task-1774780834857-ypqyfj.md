...
- agent: news/news
- requestId: 1774780834857-ypqyfj
- 生成时间(UTC): 2026-03-29T10:43:47.768Z
...
graph TD
  subgraph "Concept Map"
    C1["带着镣铐跳舞 / Dancing with Shackles"]
    C2["历史大势 / Historical Trend"]
    C3["还原历史细节 / Historical Restoration"]
    C2 --> C3
  end
```
...
flowchart LR
  subgraph "Causal Chain"
    T["历史小说创作 / Historical Novel Creation"]
    R["历史小说创作需要在遵循历史事实的基础上发挥文学想象"]
    A["历史小说创作需遵循历史大势与细节还原"]
    T --> R
    R --> A
  end
```
