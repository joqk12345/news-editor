...
- agent: news/news
- requestId: 1774077435566-8c3m9t
- 生成时间(UTC): 2026-03-21T07:19:07.429Z
...
graph TD
  subgraph "Concept Map"
    AI眼镜["AI眼镜 / AI Glasses"] --> 数据采集枢纽["数据采集枢纽 / Data Collection Hub"]
    可穿戴设备["可穿戴设备 / Wearable Devices"] --> 数据采集枢纽
    数据采集枢纽 --> 世界模型["世界模型 / World Model"]
    世界模型 --> 主动干预["主动智能决策干预 / Proactive Intervention"]
    AlwaysOn["Always On / Always On"] --> AI眼镜
    第一视角["人类第一视角 / Human First-Person Perspective"] --> AI眼镜
    生理体征["生理体征 / Physiological Signs"] --> 可穿戴设备
    隐形世界["隐形世界 / Invisible World"] --> 可穿戴设备
    大语言模型["大语言模型 / Large Language Model"] -.->|无法做到| 世界模型
  end
```
