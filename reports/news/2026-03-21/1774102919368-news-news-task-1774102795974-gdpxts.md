...
- agent: news/news
- requestId: 1774102795974-gdpxts
- 生成时间(UTC): 2026-03-21T14:21:59.364Z
...
graph TD
  subgraph "Concept Map"
    F["节日 / Festival"] --> P["恐慌 / Panic"]
    P --> D["下跌 / Decline"]
    PI["价格上涨 / Price Increase"] --> E["进场 / Market Entry"]
    W["战争 / War"] --> X["跨越制度 / Cross-Institutional"]
    IL["病患 / Illness"] --> X
    POV["贫穷 / Poverty"] --> X
    DCA["定投策略 / Dollar-Cost Averaging"] --> X
    Diff["困难 / Difficulty"] --> X
    Obs["障碍 / Obstacle"] --> X
    C["抱怨 / Complaint"] --> U["无用 / Useless"]
    A["注意力 / Attention"] --> PR["宝贵 / Precious"]
  end
```
### Mermaid 图 2（逻辑/因果图）
```mermaid
flowchart LR
  subgraph "Causal Chain"
    ...
    PI["价格上涨 / Price Increase"] --> E["进场 / Market Entry"]
    E --> D
    W["战争 / War"] --> I["制度无关性 / Institutional Irrelevance"]
    IL["病患 / Illness"] --> I
    POV["贫穷 / Poverty"] --> I
    DCA["定投策略 / Dollar-Cost Averaging"] --> I
  end
```
