...
- agent: news/news
- requestId: 1774602686721-qydd2r
- 生成时间(UTC): 2026-03-27T09:17:37.328Z
...
graph TD
  subgraph "Concept Map"
    ...
    C2["算力门槛 / Computational Barrier"]
    C3["数据质量 / Data Quality"]
    C4["工程化差距 / Engineering Gap"]
    C5["安全隐患 / Safety Risks"]
    C6["区块链约束 / Blockchain Constraints"]
    C1 --> C2
    C3 --> C4
    C5 --> C6
  end
...
flowchart LR
  subgraph "Causal Chain"
    T["开源具身智能 / Open-Source Embodied Intelligence"]
    R["算力成本高昂"]
    A["开发轻量化模型（如Octo）"]
    T --> R
    R --> A
