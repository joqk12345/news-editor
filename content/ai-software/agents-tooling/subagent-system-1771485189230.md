...
description: "全面介绍Claude Code中子代理的创建、配置、运行机制及最佳实践，涵盖上下文管理、持久化内存、条件规则等高级功能。"
generatedBy: "reports-pipeline"
generatedType: "report"
tags: [ai-software, agents-tooling, task, link-summary, ai, agents, tooling, models]
...
sourceBucket: "task"
source: "reports/2026-02-19/1771485643750-task-1771485189230-wtbvat.md"
requestId: "1771485189230-wtbvat"
---

> 全面介绍Claude Code中子代理的创建、配置、运行机制及最佳实践，涵盖上下文管理、持久化内存、条件规则等高级功能。
...
- 文档类型：`link-summary`
- 来源分组：`task`
- 原始文件：`reports/2026-02-19/1771485643750-task-1771485189230-wtbvat.md`
- 请求 ID：`1771485189230-wtbvat`
