...
description: "Voxtral TTS是Mistral AI发布的第一款文本转语音模型，具备多语言语音生成、低延迟、易适应等核心特性，支持9种语言，原生生成最多两分钟音频，企业用户可通过Mistral Studio或API（每千字符$0.016）测试该模型。"
generatedBy: "reports-pipeline"
generatedType: "report"
tags: [ai-software, models-research, news, link-summary, ai, agents, tooling, models]
...
sourceBucket: "news"
source: "reports/news/2026-03-27/1774618776305-news-news-task-1774618436882-g345jl.md"
requestId: "1774618436882-g345jl"
---

> Voxtral TTS是Mistral AI发布的第一款文本转语音模型，具备多语言语音生成、低延迟、易适应等核心特性，支持9种语言，原生生成最多两分钟音频，企业用户可通过Mistral Studio或API（每千字符$0.016）测试该模型。
...
- 文档类型：`link-summary`
- 来源分组：`news`
- 原始文件：`reports/news/2026-03-27/1774618776305-news-news-task-1774618436882-g345jl.md`
- 请求 ID：`1774618436882-g345jl`
